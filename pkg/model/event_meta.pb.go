...
func (x *EventMetaLifecycleGRPC) GetEventBase() *EventBaseGRPC {
	if x != nil {
		return x.EventBase
	}
	return nil
...
func (x *EventMetaHeartbeatGRPC) GetEventBase() *EventBaseGRPC {
	if x != nil {
		return x.EventBase
	}
	return nil
...
func (x *EventMetaHeartbeatGRPC) GetStatus() map[string]string {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *EventMetaHeartbeatGRPC) GetInterval() int64 {
	if x != nil {
		return x.Interval
	}
	return 0
...
var file_event_meta_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0x67, 0x0a, 0x16, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	,
...
var file_event_meta_proto_goTypes = []interface{}{
	...
	(*EventMetaHeartbeatGRPC)(nil), // 2: model.EventMetaHeartbeatGRPC
	nil,                            // 3: model.EventMetaHeartbeatGRPC.StatusEntry
	(*EventBaseGRPC)(nil),          // 4: model.EventBaseGRPC
}
var file_event_meta_proto_depIdxs = []int32{
	4, // 0: model.EventMetaBaseGRPC.eventBase:type_name -> model.EventBaseGRPC
	4, // 1: model.EventMetaLifecycleGRPC.eventBase:type_name -> model.EventBaseGRPC
	4, // 2: model.EventMetaHeartbeatGRPC.eventBase:type_name -> model.EventBaseGRPC
	3, // 3: model.EventMetaHeartbeatGRPC.status:type_name -> model.EventMetaHeartbeatGRPC.StatusEntry

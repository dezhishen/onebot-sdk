...
// 	protoc        v3.19.1
// source: message_element_rps.proto
...
var file_message_element_rps_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x52, 0x70, 0x73, 0x47, 0x52, 0x50, 0x43, 0x42, 0x31, 0x5a, 0x2f, 0x67,
...
var (
	file_message_element_rps_proto_rawDescOnce sync.Once
	file_message_element_rps_proto_rawDescData = file_message_element_rps_proto_rawDesc
)

func file_message_element_rps_proto_rawDescGZIP() []byte {
	file_message_element_rps_proto_rawDescOnce.Do(func() {
		file_message_element_rps_proto_rawDescData = protoimpl.X.CompressGZIP(file_message_element_rps_proto_rawDescData)
	})
	return file_message_element_rps_proto_rawDescData
}
...
func init() { file_message_element_rps_proto_init() }
func file_message_element_rps_proto_init() {
	if File_message_element_rps_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_message_element_rps_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_message_element_rps_proto_goTypes,
		DependencyIndexes: file_message_element_rps_proto_depIdxs,
		MessageInfos:      file_message_element_rps_proto_msgTypes,
	}.Build()
	File_message_element_rps_proto = out.File
	file_message_element_rps_proto_rawDesc = nil
	file_message_element_rps_proto_goTypes = nil
	file_message_element_rps_proto_depIdxs = nil
}

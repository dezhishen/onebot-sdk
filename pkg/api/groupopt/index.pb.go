...
func (x *SetGroupSpecialTitleRequest) GetDuration() int32 {
	if x != nil {
		return x.Duration
	}
	return 0
...
func (x *SetGroupBanRequest) GetDuration() int32 {
	if x != nil {
		return x.Duration
	}
	return 0
...
var file_index_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4b, 0x0a, 0x16,
	...
	0x05, 0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4d, 0x0a, 0x18, 0x53,
